  ...
  ">
   ...
   <div class="d-flex justify-content-center form-check form-switch mb-3">
    ...
    <div style="padding: 1rem;" class="text-break">
      <h3 style="margin: 0 0 0.5rem 0; color: #333;">${projectName}</h3>
      <p style="margin: 0 0 1rem 0; font-size: 0.9rem; color: #555;">${projectDescription}</p>
...
div {
 ...
 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrows-angle-contract" viewBox="0 0 16 16">
  ...
  <!-- Project Info Section -->
    ...
    <h3 style="margin: 0 0 0.5rem 0;" class="text-light">${nameProject}</h3>
    <p style="margin: 0 0 1rem 0; font-size: 0.9rem;" class="text-light text-opacity-75">${descriptionProject}</p>
