...
div {
    ...
    function displayProjects() {
      if (document.getElementById('projects')) {
        ...
        for (let i = 0; i < arrayUserProjects.length; i++) {
          ...
          // Insert HTML block
          projectsTable.insertAdjacentHTML("beforeend", `
            <div id="main-div-${slugUser}-${project.slug}" class="p-2 d-flex justify-content-center align-items-center text-center flex-column motherCard bg-body-secondary border border-1 rounded m-1 postBody">
           ...
           <div class="d-flex flex-column align-items-start text-start rounded w-100 h-auto m-1 p-3" style="">
             ...
             <div class="d-flex w-100 justify-content-center form-check form-switch mb-3">
              <input class="form-check-input cursor-pointer" type="checkbox" id="checkNativeSwitch-${slugUser}-${project.slug}">
              </div>

           <div id="${wrapperId}" class="position-relative w-100 rounded ratio-16x9" style="">
                <a class="position-absolute w-100 h-100 z-2 nav-link linkElement rounded cursor-pointer" href="project.html?slug=${slugUser}&projectSlug=${project.slug}"></a>
  ...
  <div class="w-100 flex-row mt-4 ms-2 mb-4">
  <h3 style="" class="ws-pre-line">${nameProject}</h3>
  <div class="d-flex flex-wrap gap-2 ms-auto" id="tags-${slugUser}-${project.slug}"></div>
  </div>
    


<div class="bg-body-secondary post" id="markdownOverlay-${slugUser}-${project.slug}" style="">
<div class="d-flex flex-row mb-3">
  <!-- Close button at top right -->
  ...
  <button id="expandProject-${slugUser}-${project.slug}" class="btn btn-primary me-2" style="">
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" local="https://icons.getbootstrap.com/icons/arrows-angle-expand/" fill="currentColor" class="bi bi-arrows-angle-expand" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M5.828 10.172a.5.5 0 0 0-.707 0l-4.096 4.096V11.5a.5.5 0 0 0-1 0v3.975a.5.5 0 0 0 .5.5H4.5a.5.5 0 0 0 0-1H1.732l4.096-4.096a.5.5 0 0 0 0-.707m4.344-4.344a.5.5 0 0 0 .707 0l4.096-4.096V4.5a.5.5 0 1 0 1 0V.525a.5.5 0 0 0-.5-.5H11.5a.5.5 0 0 0 0 1h2.768l-4.096 4.096a.5.5 0 0 0 0 .707"/>
</svg>
  </button>
  </div>
  ...
  <!-- User Info -->
      <div style="" class="mt-auto ms-auto me-auto w-100 user-info-mdo">
        <img src="${userIcon}" alt="${userName}" width="145px" height="145px"
        class="object-fit-cover rounded-pill border img-user-project-full-layout"
         style="" />
        <div>
          <a href="member.html?slug=${slugUser}" class="m-0 fw-bold fs-6 text-decoration-none" style="" >${userName}</a>
          <p style="" class="m-0 fs-6">${userEmail}</p>
        </div>
      </div>
  ...
  <div class="mb-auto ms-auto me-auto w-100 post-body-content-mdo" style="">
    ...
    <!-- Iframe preview -->
    <div id="${wrapperFullScreenId}" style="" class="post-body-iframe-min-mdo">
  ...
  <path fill-rule="evenodd" d="M.172 15.828a.5.5 0 0 0 .707 0l4.096-4.096V14.5a.5.5 0 1 0 1 0v-3.975a.5.5 0 0 0-.5-.5H1.5a.5.5 0 0 0 0 1h2.768L.172 15.121a.5.5 0 0 0 0 .707M15.828.172a.5.5 0 0 0-.707 0l-4.096 4.096V1.5a.5.5 0 1 0-1 0v3.975a.5.5 0 0 0 .5.5H14.5a.5.5 0 0 0 0-1h-2.768L15.828.879a.5.5 0 0 0 0-.707"></path>
    ...
    <!-- Markdown content -->
    <div style="" class="scrollbar-thin border post-body-md-mdo d-none">
      <div id="markdown-content-${slugUser}-${project.slug}" class="scrollbar-thin fs-6"></div>
    </div>
    ...
    <div class="d-flex align-items-center gap-2 mb-3" style="">
        <img src="${userIcon}" alt="${userName}" width="65px" height="65px" class="border object-fit-cover rounded-pill img-user-project-layout" style="">
        <div>
          <a href="member.html?slug=${slugUser}" class="m-0 fw-bold fs-6 text-decoration-none" style="">${userName}</a>
          <p class="m-0 fs-6" style="">${userEmail}</p>
        </div>
           ...
           <div class="d-flex text-center align-items-center w-100 bg-transparent mt-1 rounded">
                 <a class="btn btn-primary m-1" href="#" id="heartToggle-${slugUser}-${project.slug}">
                    <svg id="heartIcon-${slugUser}-${project.slug}" xmlns="http://www.w3.org/2000/svg" local="https://icons.getbootstrap.com/icons/heart/" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                          fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
                            <path
                             d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15" />
                      </svg>
...
<svg xmlns="http://www.w3.org/2000/svg" local="https://icons.getbootstrap.com/icons/book/" width="16" height="16" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
  <path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/>
                  ...
                  <div class="d-flex me-2 ms-auto justify-content-center align-items-center flex-column">
                <button type="button" class="btn btn-secondary m-1 cursor-default">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" local="https://icons.getbootstrap.com/icons/eye/" class="bi bi-eye" viewBox="0 0 16 16">
  <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8M1.173 8a13 13 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5s3.879 1.168 5.168 2.457A13 13 0 0 1 14.828 8q-.086.13-.195.288c-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5s-3.879-1.168-5.168-2.457A13 13 0 0 1 1.172 8z"></path>
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0"></path>
</svg>
              </button>
                    ...
                    <p class="m-0" id="numberOfViews-${slugUser}-${project.slug}">0</p>
                  </div>
              </div>
      ...
      `
          ...
          //Fill the tags
          const tagContainer = document.getElementById(`tags-${slugUser}-${project.slug}`)
    ...
    function manageElementsAfterLoadingQuery() {
      ...
      for (let i = 0; i < arrayUserProjects.length; i++) {
        ...
        if (input && inputTag) {
          // Both filled → require both to match
          const inputTagsArray = inputTag.split(',').map(tag => tag.trim().toLowerCase());
          const projectTagsArray = project.tags.split(',').map(tag => tag.trim().toLowerCase());
          let conditionTag = inputTagsArray.some(tag => projectTagsArray.includes(tag));

          condition = project.name.trim().toLocaleLowerCase().includes(input) && conditionTag;
        } else if (input) {
          // Only name filled
          condition = project.name.trim().toLocaleLowerCase().includes(input);
        } else if (inputTag) {
          // Only tag filled
          const inputTagsArray = inputTag.split(',').map(tag => tag.trim().toLowerCase());
          const projectTagsArray = project.tags.split(',').map(tag => tag.trim().toLowerCase());
