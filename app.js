        ...
        for (let i = 0; i < arrayUserProjects.length; i++) {
          ...
          projectsTable.insertAdjacentHTML("beforeend", `
            <div class="p-2 d-flex justify-content-center align-items-center text-center flex-column" style="height: auto; max-width: 600px; width: 90%;">
              ...
              <div class="d-flex text-center align-items-center w-100 bg-dark mt-1 rounded bg-black bg-gradient">
              ...
              <div class="d-flex align-items-center text-center rounded flex-row w-100 h-100 m-1 bg-black bg-gradient bg-opacity-50">

              <div class="d-flex m-1 justify-content-center align-content-between text-center flex-column flex-shrink-0" style="width: 70px; height: 70px;">
              <img src=${userIcon} class="w-100 h-100 object-fit-cover rounded">
              </div>

              <div class="d-flex align-items-start text-start flex-column">
              <h6 class="m-1 text-light">${nameProject}</h6>
              <a class="m-1 fs-6 text-light fw-lighter" href="member.html?slug=${slugUser}">${userName}</a>
              </div>
