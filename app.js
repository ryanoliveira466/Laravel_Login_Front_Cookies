      ...
      if (document.getElementById('searchProjectsInput')) {
        ...
        document.getElementById('searchProjectsInput').addEventListener('input', function () {
          ...
          for (let i = 0; i < arrayProjects.length; i++) {
            ...
            <div class="p-2 d-flex justify-content-center align-items-center text-center flex-column motherCard bg-body-secondary border border-1 rounded m-1 postBody hidden-animation">
